...
import static de.poeschl.apps.debuganddelete.data.MockPackageList.TEST_PACKAGE_0;
import static de.poeschl.apps.debuganddelete.data.MockPackageList.TEST_PACKAGE_1;
import static de.poeschl.apps.debuganddelete.data.MockPackageList.TEST_PACKAGE_2;
import static de.poeschl.apps.debuganddelete.data.MockPackageList.TEST_PACKAGE_3;
import static de.poeschl.apps.debuganddelete.data.MockPackageList.TEST_PACKAGE_NOT_ADDED;
import static de.poeschl.apps.debuganddelete.data.SharedPreferencesPackageList.PREF_PACKAGE_LIST;
