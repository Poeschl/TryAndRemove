...
/**
 * This intent service cares about the broadcasts from the {@link de.poeschl.apps.debuganddelete.broadcastReciever.AppDetectionReceiver}
 */
public class ApplicationDetectionService extends IntentService {
    ...
    public void onCreate() {
        ...
        DebugAndDeleteApp app = DebugAndDeleteApp.get(ApplicationDetectionService.this);
        app.inject(this);
    }
